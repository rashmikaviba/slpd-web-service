...
import VehicleMaintenanceRouter from './modules/vehicleMaintain/vehicleMaintenance.route';
...
router.use(applicationRoutes.vehicleMaintenance.base, VehicleMaintenanceRouter);
